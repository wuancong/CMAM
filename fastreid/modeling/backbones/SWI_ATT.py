...
from .utils.rga_modules import RGA_Module
...
class ResNetV2SN(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, using_moving_average=True, using_bn=True,spa_on=True, cha_on=True, s_ratio=8, c_ratio=8, d_ratio=8, height=384, width=128):
        ...
        self.rga_att3 = RGA_Module(1024, (height // 16) * (width // 16), use_spatial=spa_on, use_channel=cha_on,
                                   cha_ratio=c_ratio, spa_ratio=s_ratio, down_ratio=d_ratio)
        self.rga_att4 = RGA_Module(2048, (height // 32) * (width // 32), use_spatial=spa_on , use_channel=cha_on,
                                   cha_ratio=c_ratio, spa_ratio=s_ratio // 4, down_ratio=d_ratio)
...
def build_swi_att_backbone(cfg):
    import numpy as np
    """

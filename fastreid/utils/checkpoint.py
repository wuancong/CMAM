...
class PeriodicCheckpointer:
    ...
    def step(self, iteration: int, **kwargs: Any):
        ...
        #         self.checkpointer.save_pre +  "model_{:07d}".format(iteration), **additional_state
        #     )
        if iteration >= self.max_iter - 1:
            self.checkpointer.save(self.checkpointer.save_pre + "model_final", **additional_state)
    ...
    def save(self, name: str, **kwargs: Any):
        ...
        Args:
            ...
            kwargs (Any): extra data to save, same as in
                :meth:`Checkpointer.save`.
        """
        self.checkpointer.save( self.checkpointer.save_pre + name, **kwargs)

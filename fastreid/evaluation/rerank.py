...
def re_ranking(q_g_dist, q_q_dist, g_g_dist, k1: int = 20, k2: int = 6, lambda_value: float = 0.3):
    ...
    final_dist2 = final_dist[:query_num, query_num:]
    all_dist = final_dist
    return final_dist2


def re_ranking2(q_g_dist, q_q_dist, g_g_dist, k1: int = 20, k2: int = 6, lambda_value: float = 0.3):
    original_dist = np.concatenate(
        [np.concatenate([q_q_dist, q_g_dist], axis=1),
         np.concatenate([q_g_dist.T, g_g_dist], axis=1)],
        axis=0)
    ...
    return final_dist, 1 - jaccard_dist[:query_num,query_num:]